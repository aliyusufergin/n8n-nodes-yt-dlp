...
| `REQUEST_TIMEOUT` | The yt-dlp process made no progress for five minutes and its process group was terminated. There is no request duration limit to raise. Check egress to the origin, the proxy, and whether the source stalls mid-transfer. |
